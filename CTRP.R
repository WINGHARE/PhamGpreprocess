...
DATA.meta.control <- DATA.meta[DATA.meta$xptype=="control",]
save(DATA.meta.control,file="DATA/L1000meta_control.RData")

save(DATA.meta,file="DATA/L1000meta.RData")
...
save(DATA.control.expression.transpose,file="DATA/L1000control.RData")
